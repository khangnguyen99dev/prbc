export const STYLE_ELEMENT = `
	...
	#BOX1>.ladi-box {
		background-image: linear-gradient(rgb(253, 251, 251), rgb(242, 242, 242));
	...
	#PARAGRAPH130.ladi-animation>.ladi-paragraph,
	...
	#PARAGRAPH113.ladi-animation>.ladi-paragraph,
	...
	#PARAGRAPH127.ladi-animation>.ladi-paragraph {
	...
	#PARAGRAPH68.ladi-animation>.ladi-paragraph,
	#PARAGRAPH131.ladi-animation>.ladi-paragraph,
	...
	#PARAGRAPH75.ladi-animation>.ladi-paragraph {
	...
	#IMAGE5>.ladi-image>.ladi-image-background {
		background-image: url("assets/template-1/images/thiet-ke-chua-co-ten-20240719043943--sw74.png");
	}
	...
	#LINE22.ladi-animation>.ladi-line,
	...
	#IMAGE15>.ladi-image>.ladi-image-background {
		...
		top: -33.7775px;
		left: 2.25183px;
		background-image: url("assets/template-1/images/save-the-date-wavy-elegant-calligraphy-spelling-for-decoration-of-the-wedding-invitation-vector-20240602022740-gjzzl.png");
	}
	...
	#IMAGE8>.ladi-image>.ladi-image-background {
		width: 420px;
		height: 640.3px;
		background-image: url("assets/template-1/images/thiet-ke-chua-co-ten-20240719043943--sw74_1.png");
	}
	...
	#IMAGE13>.ladi-image>.ladi-image-background {
		background-image: url("assets/template-1/images/1-20240829040139-e_nln.png");
	}
	...
	#FORM8 .ladi-form .ladi-form-checkout-payment-item {
	...
	#FORM8 .ladi-form-checkout-payment-quantity input {
		color: rgb(0, 0, 0);
	}
	...
	#FORM8 .ladi-form [data-form-checkout-item="product"] .ladi-form-checkout-payment-check.multiple.checked:before,
	#FORM8 .ladi-form [data-form-checkout-item="product"] .ladi-form-checkout-payment-check:not(.multiple).checked:before,
	#FORM8 .ladi-form [data-form-checkout-item="payment"] .ladi-form-checkout-payment-check.checked:before,
	#FORM8 .ladi-form-checkout-payment-quantity .up:before,
	#FORM8 .ladi-form-checkout-payment-quantity .down:before,
	#FORM8 [data-form-checkout-item="payment"] .ladi-form-item .ladi-form-checkout-payment-content div:before,
	...
	#PARAGRAPH128.ladi-animation>.ladi-paragraph,
	#GROUP111.ladi-animation>.ladi-group {
		animation-name: fadeInUp;
		animation-delay: 0s;
	...
	#BUTTON45>.ladi-button:hover .ladi-button-background,
	...
	#IMAGE29>.ladi-image>.ladi-image-background {
		...
		top: -135px;
		left: -98px;
		background-image: url("assets/template-1/images/thiet-ke-chua-co-ten-20240719043943--sw74_2.png");
	}
	...
	#IMAGE17>.ladi-image>.ladi-image-background {
		width: 200px;
		height: 196.667px;
		background-image: url("assets/template-1/images/png-clipart-leaves-and-flowers-pink-petaled-flower-20240610165153-_8jb_.png");
	}
	...
	#SHAPE53:hover>.ladi-shape svg:last-child {
		fill: rgb(162, 40, 40);
	}
	...
	#BOX18>.ladi-box {
		...
		background-image: url("assets/template-1/images/uffTbu4J20210123080902.jpeg");
	...
	#IMAGE19>.ladi-image>.ladi-image-background {
		background-image: url("assets/template-1/images/14-20240719053009-27sg6.png");
	}
	...
	#SECTION12>.ladi-section-background {
		background-image: url("assets/template-1/images/thiet-ke-chua-co-ten-20240719043943--sw74_6.png");
		background-size: cover;
		background-origin: content-box;
		background-position: 50% 0%;
		background-repeat: repeat;
	...
	#PARAGRAPH155.ladi-animation>.ladi-paragraph {
	...
	#GROUP148.ladi-animation>.ladi-group {
	...
	#HEADLINE96>.ladi-headline {
		font-family: VVRNIEEmUyBIZWFydGJlYXQudHRm;
		font-size: 50px;
		line-height: 1.6;
		color: rgb(139, 91, 19);
		letter-spacing: 3px;
	...
	#SECTION15>.ladi-section-background {
		background-image: url("assets/template-1/images/thiet-ke-chua-co-ten-20240719043943--sw74_3.png");
		background-size: cover;
		background-origin: content-box;
		background-position: 50% 0%;
		background-repeat: repeat;
	...
	#IMAGE20>.ladi-image>.ladi-overlay {
	...
	#BOX24>.ladi-box,
	#video>.ladi-popup>.ladi-popup-background,
	...
	#SECTION22>.ladi-section-background {
		background-image: url("assets/template-1/images/thiet-ke-chua-co-ten-20240719043943--sw74_5.png");
		background-size: cover;
		background-origin: content-box;
		background-position: 50% 0%;
		background-repeat: repeat;
	...
	#SECTION16>.ladi-overlay {
		background-image: url("assets/template-1/images/74b0151a0301117602e913efb67ddd36-20240702092519-9peja.jpg");
		background-size: cover;
		background-origin: content-box;
		background-position: 50% 0%;
		background-repeat: repeat;
	...
	#SECTION16>.ladi-section-background {
		background-image: url("assets/template-1/images/thiet-ke-chua-co-ten-20240719043943--sw74_4.png");
		background-size: cover;
		background-origin: content-box;
		background-position: 50% 0%;
		background-repeat: repeat;
	...
	#FORM8 .ladi-form-item .ladi-form-control-select {
		text-align-last: left;
	}

	#FORM8 .ladi-form-item-container,
	#FORM8 .ladi-form-checkout-box,
	...
	#FORM8 .ladi-form [data-form-checkout-item="total_price"] .space,
	#FORM8 .ladi-form-checkout-payment-quantity input {
		border-color: rgb(153, 155, 156);
	}
	...
	#FORM_ITEM13 .ladi-form-checkbox-item {
		margin-top: 8px;
		margin-bottom: 8px;
		margin-left: 8px;
	...
	#FORM_ITEM13 .ladi-form-item.ladi-form-checkbox,
	#FORM_ITEM14 .ladi-form-item.ladi-form-checkbox {
		padding-top: 8px;
		padding-bottom: 8px;
	}

	#FORM_ITEM13 .ladi-form-item.ladi-form-checkbox .ladi-form-checkbox-item input,
	#FORM_ITEM14 .ladi-form-item.ladi-form-checkbox .ladi-form-checkbox-item input {
		width: 13px;
		height: 13px;
	}

	#FORM_ITEM13 .ladi-form-item.ladi-form-checkbox .ladi-form-checkbox-item span,
	...
	#PARAGRAPH105.ladi-animation>.ladi-paragraph {
		animation-name: fadeInDown;
		animation-delay: 0s;
		animation-duration: 3s;
		animation-iteration-count: 1;
	...
	#VIDEO1.ladi-animation>.ladi-video {
		animation-name: fadeInUp;
		animation-delay: 1s;
		animation-duration: 1s;
		animation-iteration-count: 1;
	...
	#PARAGRAPH132.ladi-animation>.ladi-paragraph {
		animation-name: fadeInDown;
		animation-delay: 1s;
		animation-duration: 2s;
		animation-iteration-count: 1;
	...
	#Thanks-LC>.ladi-popup>.ladi-popup-background,
	#Thanks-XNTD>.ladi-popup>.ladi-popup-background {
		background-image: url("assets/template-1/images/thiet-ke-chua-co-ten-20240715145320-0prca.png");
		background-size: cover;
		background-origin: content-box;
		background-position: 50% 50%;
		background-repeat: repeat;
